...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//cuerpo
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(20.0f, 15.0f, 25.0f));
		...
		//pata der
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(8.0f, 9.0f, 2.0f));
		model = glm::translate(model, glm::vec3(-1.75f, -2.0f, 5.5f));
		model = glm::rotate(model, 1.6f, glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//pie der
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(8.0f, 5.0f, 2.0f));
		model = glm::translate(model, glm::vec3(-1.75f, -4.0f, 6.5f));
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(8.0f, 5.0f, 2.0f));
		model = glm::translate(model, glm::vec3(-1.75f, -4.0f, -4.5f));
		model = glm::rotate(model, 1.6f, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
