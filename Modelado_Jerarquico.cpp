...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 modelTempMuñeca = glm::mat4(1.0f); //Temp
		...
		modelTempMuñeca = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		...
		//DEDO1
		model = glm::translate(modelTempMuñeca, glm::vec3(0.25f, 0.35f, 0.375f));
		...
		//dedo3
		model = glm::translate(modelTempMuñeca, glm::vec3(0.25f, -0.130f, 0.0f));
		...
		//dedo5
		model = glm::translate(modelTempMuñeca, glm::vec3(0.25f, -0.875f, 0.0f));
		...
		//dedo4
		model = glm::translate(modelTempMuñeca, glm::vec3(0.25f, -0.130f, -0.375f));
