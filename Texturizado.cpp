...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Texturizado Uriel Gabriel Ortiz ", nullptr, nullptr);
	...
	// Diffuse map
	image = stbi_load("images/dado2.PNG", &textureWidth, &textureHeight, &nrChannels,0);
	glBindTexture(GL_TEXTURE_2D, texture1);
